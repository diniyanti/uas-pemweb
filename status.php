      ...
      <a href="#" class="card__link">
        <!-- <header> -->
          <div class="card__header">
              <center>
            <h1 class="card__header-title">ZAHARA COLLECTION</h1>
            <h4 class="card__header-title"> Penyewaan Costum</h4>
            </center>
            <hr size="3px" color="black">
            <h4>Tanggal sewa  : <?php echo $tampil['tgl_sewa']; ?></h4>
            <h4>Kode Sewa  : <?php echo $tampil['kode_sewa']; ?></h4>
            <h4>produk : <?php echo $tampil['nama_produk']; ?></h4>
            ...
            <p style="color: #FF0000" class="card__header-meta"></p>
            <a class="button-print" href="proses_cetak.php?id=<?php echo $tampil['id_sewa']; ?>">Cetak</a>
